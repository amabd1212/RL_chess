...
save_data(win_rate1000, 'win_rate_SARSA_1000.json')
save_data(move_count1000, 'move_count_SARSA_1000.json')
save_data(reward_history1000, 'reward_history_SARSA_1000.json')
