...
save_data(win_rate1000, 'win_rate_Q_1000.json')
save_data(move_count1000, 'move_count_Q_1000.json')
save_data(reward_history1000, 'reward_history_Q_1000.json')
...
plot_data(reward_history1000,'Average Reward', 'Average Reward over 1000 Episodes', 'reward_Q_1000.png')
